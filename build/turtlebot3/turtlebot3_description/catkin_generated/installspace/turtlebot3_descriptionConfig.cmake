...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot3_description_SOURCE_PREFIX /home/max/catkin_ws/src/turtlebot3/turtlebot3_description)
  set(turtlebot3_description_DEVEL_PREFIX /home/max/catkin_ws/devel)
  ...
  set(turtlebot3_description_INSTALL_PREFIX /home/max/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtlebot3_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtlebot3_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/max/catkin_ws/install/${idir}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
    endif()
